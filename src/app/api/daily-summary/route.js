...
DAILY OVERVIEW — Write SIX short summaries, one per section of the Daily Overview table. Each is 1-3 sentences, grounded ONLY in the metrics listed for that section. Compare to avg7/avg30 when those baselines exist; say "insufficient history" when they do not.
  ...
  revenue: Premium, Gross Adv Revenue (GAR), Commission, Net Revenue (NAR), Avg Premium per App. Goals: Premium $500/day, GAR $4000/day, Commission $1000/day, NAR $2000/day.
    REQUIRED FRAMING for the revenue section:
    1. LEAD WITH NET REVENUE vs goal. NAR is the bottom line — open with today's NAR in dollars, as % of the $2000 goal, and as delta vs 30d avg. Example: "NAR $1,486 = 74% of $2k goal, +6% vs 30d avg." NAR is derived as GAR − Lead Spend − Commission; do not re-derive it.
    2. NAME THE DELTA DIRECTION CORRECTLY. The BASELINES block emits "Δ30=X%" — a positive number means today is ABOVE the 30-day average; a negative number means BELOW. Always quote the actual delta magnitude AND direction. Never invert the sign. Distinguish GOAL deltas (vs the goals listed at the top of this section) from 30D BASELINE deltas (from the BASELINES block) — these are two different reference points and may go in opposite directions. State both when they diverge: "$62 avg premium per app = -12% vs $70 goal AND +10% vs $56 30d avg".
    3. DECOMPOSE COMPONENTS EXPLICITLY. GAR comes from Premium × advance months (~9 for most carriers, 6 for CICA). Commission comes from Premium × 3 for standard products, ×1.5 for GIWL. If Commission moved sharply without Premium moving, flag a MIX SHIFT (different carrier / product ratio). Example: "Commission +21% while Premium -25% = commission-to-premium ratio 3.0 vs typical 1.8 — sales mix shifted toward higher-commission products."
